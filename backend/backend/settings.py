...
# SECRET_KEY = 'django-insecure-4uh2u-5nbjl$dldev*2z3e+o7*8+b+&km71#^@xmg8f!5auw*_'
...
# CORS_ALLOW_ALL_ORIGINS = True  # Temporary for development (replace with specific origins later)
